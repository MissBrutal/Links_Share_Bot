...
ABOUT_TXT = """<b>›› ᴄᴏᴍᴍᴜɴɪᴛʏ: <a href='https://t.me/MrBrutal_Support'>Support Group</a>
<blockquote expandable>›› ᴜᴘᴅᴀᴛᴇs ᴄʜᴀɴɴᴇʟ: <a href='https://t.me/MrBrutal_Bots'>Cʟɪᴄᴋ ʜᴇʀᴇ</a>
...
DATABASE_CHANNEL = int(os.environ.get("DATABASE_CHANNEL", "-1002471969741")) # Channel where user links are stored
#--- ---- ---- --- --- --- - -- -  - - - - - - - - - - - --  - -

try:
    ADMINS = []
    for x in (os.environ.get("ADMINS", "6318243977").split()):
        ADMINS.append(int(x))
except ValueError:
